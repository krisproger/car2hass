...
public class RuleEditActivity extends BaseLocalizedActivity {
    ...
    private void notifyEngineChanged() {
        try {
            com.car2hass.service.TelemetryService ts =
                    com.car2hass.MainActivity.getTelemetryService();
