...
-keep class com.car2hass.GeofenceZone { *; }
-keep class com.car2hass.DashboardTile { *; }
-keep class com.car2hass.rules.Rule { *; }
-keep class com.car2hass.rules.RuleCondition { *; }
-keep class com.car2hass.rules.RuleAction { *; }
