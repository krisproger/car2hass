...
public class RuleRegistry {
    ...
    public static synchronized void seedExamplesIfFirstRun(Context ctx) {
        try {
            ...
            com.diplustohass.LogBuffer.i("RuleRegistry", "Seeded example rules (lang=" + (ru ? "ru" : "en") + ")");
        } catch (Exception e) {
            com.diplustohass.LogBuffer.e("RuleRegistry", "seedExamplesIfFirstRun error: " + e.getMessage());
        }
    }
    ...
    public static synchronized List<Rule> load(Context ctx) {
        ...
        try {
            ...
            com.diplustohass.LogBuffer.e("RuleRegistry", "load error: " + e.getMessage());
        }
        return rules;
    }
    ...
    public static synchronized void save(Context ctx, List<Rule> rules) {
        ...
        com.diplustohass.AppConfig.saveRulesJson(ctx, arr.toString());
    }
