...
| Что | Файл | Ссылка |
|-----|------|--------|
| Android-приложение (текущая версия) | `diplus2hass-v2.1.3.apk` | [скачать](https://teplitzky.ru/diplus2hass/download.php?file=app) |
| Интеграция HA (текущая версия) | `diplus2hass-v2.1.3.zip` | [скачать](https://teplitzky.ru/diplus2hass/download.php?file=integration) |
