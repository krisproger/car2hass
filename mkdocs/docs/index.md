...
| Что | Файл | Ссылка |
|-----|------|--------|
| Android-приложение (текущая версия) | `car2hass-v3.0.35.apk` | [скачать](https://mytechnic.ru/cartelemetry/download.php?file=app) |
| Интеграция HA (текущая версия) | `cartelemetry-v3.0.35.zip` | [скачать](https://mytechnic.ru/cartelemetry/download.php?file=integration) |
