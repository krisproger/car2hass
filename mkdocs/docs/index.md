...
| Что | Файл | Ссылка |
|-----|------|--------|
| Android-приложение (текущая версия) | `car2hass-v3.2.7.apk` | [скачать](https://mytechnic.ru/cartelemetry/download.php?file=app) |
| Интеграция HA (текущая версия) | `cartelemetry-v3.2.7.zip` | [скачать](https://mytechnic.ru/cartelemetry/download.php?file=integration) |
