...
from .const import DOMAIN, CONF_CAR_NAME, BINARY_ON_MAP, INTEGRATION_VERSION
...
async def async_setup_entry(hass, config_entry, async_add_entities):
    ...
    async_add_entities([DiplusClimate(config_entry, car_name)])


class DiplusClimate(ClimateEntity, RestoreEntity):
